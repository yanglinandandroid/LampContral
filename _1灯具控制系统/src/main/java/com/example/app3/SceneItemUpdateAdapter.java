...
public class SceneItemUpdateAdapter extends BaseAdapter {
	...
	public SceneItemUpdateAdapter(Context context) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.scene_update_item, null);
			holder = new ViewHolder();
			
			Light l = this.mData.get(position);
			
		
			holder.textView = (TextView) convertView.findViewById(R.id.text_update);
			
			holder.textView.setText(l.getName());
			holder.textView.setTag(position);
			
			holder.numEdit = (EditText) convertView.findViewById(R.id.num_edit_update);
