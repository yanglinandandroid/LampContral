...
import com.example.app3.GroupActivity.DragGridAdapterGroup;
...
public class DragGridViewGroup extends GridView{
	...
	public DragGridViewGroup(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
	    if(ev.getAction()==MotionEvent.ACTION_DOWN){
	        ...
	        */
	        //选中图标之后移动
	        View image = itemView.findViewById(R.id.drag_grid_item_image_group);
	        if(image != null )
	        {
	        	 upScrollBounce = Math.min(y-scaledTouchSlop, getHeight()/4);
		            downScrollBounce = Math.max(y+scaledTouchSlop, getHeight()*3/4);
		            ...
		            startDrag(bm, x, y);
		            //出现删除
		            GroupActivity.textview.setVisibility(View.VISIBLE);
		            GroupActivity.imageview.setVisibility(View.VISIBLE);
	        }
	    ...
	    if(dragImageView!=null&&dragPosition!=INVALID_POSITION){
	        ...
	        switch(action){
	            case MotionEvent.ACTION_UP:
	                ...
	                if(upY > 1000)
	                {
	                	DragGridAdapterGroup adapter = (DragGridAdapterGroup)getAdapter();
            ...
            else if(upY < 150)
            {
            	...
            	adapter.update(dragItem);
	                ...
	                GroupActivity.textview.setVisibility(View.INVISIBLE);
	                GroupActivity.imageview.setVisibility(View.INVISIBLE);
	                break;
	            case MotionEvent.ACTION_MOVE:
	                ...
	                if(moveY  > 1000)
	                {
	                	GroupActivity.textview.setBackgroundColor(Color.argb(70, 255, 0, 0));
	                }
	                	
	                else
	                {	
	                	GroupActivity.textview.setBackgroundColor(Color.argb( 20,255, 0, 0));	
	                }
