...
import com.example.app3.LightActivity;
import com.example.app3.LightActivity.DragGridAdapterLight;
...
public class DragGridViewLight extends GridView{
	...
	public DragGridViewLight(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
	    if(ev.getAction()==MotionEvent.ACTION_DOWN){
	        ...
	        */
	        //选中图标之后移动
	        View image = itemView.findViewById(R.id.drag_grid_item_image_light);
	        if(image != null )
	        {
	        	 	upScrollBounce = Math.min(y-scaledTouchSlop, getHeight()/4);
		            downScrollBounce = Math.max(y+scaledTouchSlop, getHeight()*3/4);
		            ...
		            startDrag(bm, x, y);
		            //出现删除
		            LightActivity.textview.setVisibility(View.VISIBLE);
		            LightActivity.imageview.setVisibility(View.VISIBLE);
	        }
	    ...
	    if(dragImageView!=null&&dragPosition!=INVALID_POSITION){
	        ...
	        switch(action){
	            case MotionEvent.ACTION_UP:
	                ...
	                if(upY > 1000)
	                {
	                	DragGridAdapterLight adapter = (DragGridAdapterLight)getAdapter();
	                ...
	                LightActivity.textview.setVisibility(View.INVISIBLE);
	                LightActivity.imageview.setVisibility(View.INVISIBLE);
	                break;
	            case MotionEvent.ACTION_MOVE:
	                ...
	                if(moveY  > 1000)
	                {
	                	LightActivity.textview.setBackgroundColor(Color.argb(70, 255, 0, 0));
	                }
	                	
	                else
	                {	
	                	LightActivity.textview.setBackgroundColor(Color.argb( 20,255, 0, 0));	
	                }
